        ...
        <div class="container mx-auto px-4 py-10">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-2/6 px-4 mb-8">
                    ...
                    <p><img src="../assets/images/logo-black.png" alt="Logo" class="h-[60px] mb-4"></p>
                    <p>Jl. Janti Kanoman, Banguntapan, Bantul Yogyakarta</p>
                    <p class="text-xl font-bold my-4">Phone: 0888-6980-000</p>
